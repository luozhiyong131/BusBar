...
/**
  ...
  * 返回值：null
  */
void Serial_PortSet::setPortName(const QString &name,Serial_PortData &serial)
{
...
/**
  ...
  * 返回值：null
  */
 void Serial_PortSet::setBaudRate(const QString baudRate,Serial_PortData &serial)
 {
